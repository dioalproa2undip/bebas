...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('tambah.ekonom') }}" method="POST">
                @csrf
                ...
                <table class="table table-bordered align-middle">
                    ...
                    <tbody>
                        @foreach($Ekonomi as $index => $kategori)
<tr>
    <td>{{ $index + 1 }}</td>
    <td>
    ...
    <td><input type="number" step="0.01" name="trisa[]" class="form-control" required></td>
    <td><input type="number" step="0.01" name="trida[]" class="form-control" required></td>
    <td><input type="number" step="0.01" name="tri[]" class="form-control" required></td>
    <td><input type="number" step="0.01" name="trifor[]" class="form-control" required></td>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                   @forelse($EkonomiSatu as $index => $item)
<tr>
    <td>{{ $index + 1 }}</td>
    <td>{{ $item->tahun }}</td>
    <td>{{ $item->kategori }}</td>
